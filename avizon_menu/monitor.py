...
from avizon_core import database, network
from avizon_menu import display
...
def system_usage():
    ...
    avizon_monitor = PrettyTable()
    avizon_monitor.field_names = [f"{display.cyan_color}Σ Upload{display.cornsilk_color}",
    ...
    while True:
        ...
        if database.get_parameter('in_submenu') is False:
            ...
            avizon_monitor.del_row(0)
            print(avizon_monitor)
            display.line_jumper(+11)
